  ...
  try {
    ...
    const offerData = [
      // iPhone 15 Pro offers
      {
        ...
        retailerId: insertedRetailers[0].id,
        price: '999.99',
      ...
      {
        productId: insertedProducts[0].id,
        retailerId: insertedRetailers[1].id,
        price: '1049.99',
        originalPrice: '1199.99',
        availability: 'in_stock',
        rating: '4.3',
      ...
      {
        productId: insertedProducts[0].id,
        retailerId: insertedRetailers[5].id,
        price: '1199.99',
        originalPrice: null,
        availability: 'in_stock',
        rating: '4.8',
        ...
        shippingInfo: 'Free shipping',
        dealType: null,
        productUrl: 'https://apple.com/iphone',
      },
      ...
      {
        productId: insertedProducts[2].id,
        retailerId: insertedRetailers[4].id,
        price: '1979.99',
        originalPrice: '2199.99',
        ...
        shippingInfo: 'Free shipping',
        dealType: 'best_price',
        productUrl: 'https://bhphotovideo.com/macbook',
      },
      ...
      },
      {
        ...
        rating: '4.4',
        reviewCount: 1543,
        shippingInfo: 'Store pickup',
        dealType: null,
        productUrl: 'https://bestbuy.com/airpods',
      },
      ...
      },
      {
        ...
        shippingInfo: 'Free shipping',
        dealType: null,
        productUrl: 'https://bhphotovideo.com/sony-headphones',
      },
      ...
      // Dell XPS 13 offers
      {
        ...
        shippingInfo: 'Free shipping',
        dealType: 'best_price',
        productUrl: 'https://amazon.com/dell-xps',
      },
      {
        productId: insertedProducts[5].id,
        retailerId: insertedRetailers[1].id,
        ...
        shippingInfo: 'Store pickup available',
        dealType: null,
        productUrl: 'https://bestbuy.com/dell-xps',
      },
      {
        productId: insertedProducts[5].id,
        retailerId: insertedRetailers[2].id,
        price: '1279.99',
        originalPrice: '1399.99',
        availability: 'limited_stock',
        rating: '4.1',
        ...
        dealType: null,
        productUrl: 'https://walmart.com/dell-xps',
      },
    ];
