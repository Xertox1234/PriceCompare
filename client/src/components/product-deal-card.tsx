      ...
      >
        ...
        <div className="relative aspect-square overflow-hidden">
          ...
          <div className="absolute top-3 left-3 z-10">
            <Badge className="gradient-success px-2 py-1 text-xs font-bold text-white shadow-lg">
        ...
        <div className="flex flex-1 flex-col space-y-3 p-4">
          ...
          <div className="space-y-1">
            <div className="flex items-baseline gap-2">
              <span className="text-foreground text-xl font-bold">${priceDisplay.current}</span>
          ...
          <p className="text-muted-foreground text-xs">
            at <span className="text-foreground font-medium">{product.retailer.name}</span>
          </p>
    ...
    <Card className={cn('overflow-hidden', className)}>
      ...
      <div className="space-y-3 p-4">
        ...
        <div className="flex gap-2 pt-2">
          ...
          <div className="bg-muted h-9 w-10 animate-pulse rounded" />
        </div>
      </div>
    </Card>
  );
