...
export function RetailerManagement() {
  ...
  const testConnectionMutation = useMutation<
    { productCount?: number; responseTime?: number },
    Error,
    number
  >({
    mutationFn: async (
      retailerId: number
    ): Promise<{ productCount?: number; responseTime?: number }> => {
      return apiRequest<{ productCount?: number; responseTime?: number }>(
        `/api/hybrid/test/${retailerId}`,
        {
          method: 'POST',
    ...
    onError: (error: unknown) => {
      const errorMessage =
        error instanceof Error ? error.message : 'Failed to connect to retailer.';
      toast({
        ...
        <TabsContent value="retailers" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage retail partners, configure API integrations, and monitor data source
                performance
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewRetailer((prev) => ({ ...prev, name: e.target.value }))
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewRetailer((prev) => ({ ...prev, website: e.target.value }))
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewRetailer((prev) => ({ ...prev, logo: e.target.value }))
                        }
                      ...
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={(checked: boolean) =>
                            setNewRetailer((prev) => ({ ...prev, hasAPI: checked }))
                          }
                        />
                        <Label htmlFor="has-api" className="text-muted-foreground text-sm">
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setNewRetailer((prev) => ({ ...prev, apiKey: e.target.value }))
                            }
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setNewRetailer((prev) => ({ ...prev, affiliateId: e.target.value }))
                            }
                        ...
                        <div className="space-y-2 md:col-span-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setNewRetailer((prev) => ({ ...prev, affiliateTag: e.target.value }))
                            }
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monitor and manage your retail partner integrations</CardDescription>
            </CardHeader>
            <CardContent>
              {retailersLoading ? (
                              ...
                              <div className="grid grid-cols-2 gap-4 text-sm md:grid-cols-4">
                                ...
                                <div className="bg-background rounded border p-2">
                                  ...
                                  <p className="font-medium">
                                    {retailer.rateLimitRemaining} remaining
                                  </p>
                                </div>
                                <div className="bg-background rounded border p-2">
                                ...
                                <div className="bg-background rounded border p-2">
                                  ...
                                  <p className="font-medium">
                                    {new Date(retailer.lastSync).toLocaleDateString()}
                                  </p>
                                </div>
                              </div>
                            )}
                ...
                <div className="text-muted-foreground py-8 text-center">
                  ...
                  <p className="mb-2 text-lg font-medium">No Retailers Found</p>
                  <p className="text-sm">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-muted-foreground py-8 text-center">
                ...
                <p className="mb-2 text-lg font-medium">Performance Metrics</p>
