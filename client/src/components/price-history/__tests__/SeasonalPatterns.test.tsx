...
describe('SeasonalPatterns', () => {
  const mockDataWithPattern = {
    ...
    dayOfWeekPatterns: [
      { dayOfWeek: 0, dayName: 'Sunday', averagePrice: 100.00, dataPoints: 5 },
      { dayOfWeek: 1, dayName: 'Monday', averagePrice: 95.00, dataPoints: 5 },
    ],
    bestMonthToBuy: {
      month: 0,
      monthName: 'January',
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle all four seasons', () => {
      const allSeasonsData = {
        ...mockDataWithPattern,
        seasonalPatterns: [
          { season: 'winter' as const, averagePrice: 85, minPrice: 80, maxPrice: 90, dataPoints: 10 },
          { season: 'spring' as const, averagePrice: 95, minPrice: 90, maxPrice: 100, dataPoints: 10 },
          { season: 'summer' as const, averagePrice: 115, minPrice: 110, maxPrice: 120, dataPoints: 10 },
          { season: 'fall' as const, averagePrice: 105, minPrice: 100, maxPrice: 110, dataPoints: 10 },
        ],
      };
