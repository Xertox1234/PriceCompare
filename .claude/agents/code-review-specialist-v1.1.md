---
name: code-review-specialist-v1.1
description: |
...
**Changes**: Added explicit reasoning, comprehensive few-shot examples, constitutional self-checks, confidence scores, and dynamic context loading
**Status**: Testing (Phase 3 - 40 test scenarios)
