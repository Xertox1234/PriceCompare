...
CREATE TABLE IF NOT EXISTS price_aggregates_weekly (
  ...
  volatility_score DECIMAL(5, 2), -- 0-100 scale
...
CREATE TABLE IF NOT EXISTS price_trends (
  ...
  trend_slope DECIMAL(10, 4), -- Linear regression slope
  trend_strength DECIMAL(5, 4), -- R² value (0-1)
  predicted_next_price DECIMAL(10, 2),
  confidence_level VARCHAR(20) CHECK (confidence_level IN ('high', 'medium', 'low')),
  analysis_period_days INTEGER NOT NULL, -- Number of days analyzed
