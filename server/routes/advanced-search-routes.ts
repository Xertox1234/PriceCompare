...
export function registerAdvancedSearchRoutes(app: Express): void {
    ...
    try {
      ...
      Object.assign(filters, {
        ...
        availability: req.query.availability
          ...
          : undefined,
        sortBy:
          (req.query.sortBy as 'price_low' | 'price_high' | 'rating' | 'popularity') ||
          filters.sortBy,
      });
   ...
   */
  app.get('/api/search/facets', (req: Request, res: Response) => {
    try {
   ...
   */
  app.get('/api/search/stats', requireAuth, requireAdmin, (req: Request, res: Response) => {
    try {
