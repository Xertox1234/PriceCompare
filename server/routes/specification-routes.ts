...
router.get('/products/:productId/specifications', async (req, res) => {
  try {
...
router.get('/products/:productId/specifications/grouped', async (req, res) => {
  try {
    const productId = parseIntSafe(req.params.productId, 'productId', { min: 1 });
...
router.get('/products/:productId/full', async (req, res) => {
  try {
    const productId = parseIntSafe(req.params.productId, 'productId', { min: 1 });
...
router.post('/admin/specifications', withAdmin(async (req, res) => {
  try {
...
router.post('/admin/specifications/batch', withAdmin(async (req, res) => {
  try {
...
router.patch('/admin/specifications/:id', withAdmin(async (req, res) => {
  try {
...
router.delete('/admin/specifications/:id', withAdmin(async (req, res) => {
  try {
    const specId = parseIntSafe(req.params.id, 'specId', { min: 1 });
...
router.delete('/admin/products/:productId/specifications', withAdmin(async (req, res) => {
  try {
    const productId = parseIntSafe(req.params.productId, 'productId', { min: 1 });
